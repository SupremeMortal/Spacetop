...
export const enum IpcEvents {
    ...
    GET_INSTANCES = "VCD_GET_INSTANCES",
    SWITCH_INSTANCE = "VCD_SWITCH_INSTANCE",
    ADD_INSTANCE = "VCD_ADD_INSTANCE",
    REMOVE_INSTANCE = "VCD_REMOVE_INSTANCE",
    INSTANCES_UPDATED = "VCD_INSTANCES_UPDATED",
    OPEN_ADD_SERVER_DIALOG = "VCD_OPEN_ADD_SERVER_DIALOG"
}
